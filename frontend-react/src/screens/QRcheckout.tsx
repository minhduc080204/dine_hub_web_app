  ...
  const App = () => {
    ...
    return (
      <View>
        <QRCode
          value={qrValue}
          size={200} // kích thước của QR code
          color='black' // màu của QR code
          backgroundColor='white' // màu nền của QR code
        />
      </View>
    );
  };
